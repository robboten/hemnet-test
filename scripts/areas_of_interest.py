...
with open("./configs/areas_of_interest_ids.yaml", "r") as stream:
...
# with open(f"{directory_path}area_info_{dateoftoday}.yml", "w") as outfile:
#     yaml.dump(area_info, outfile, default_flow_style=False, sort_keys=False)

# with open(f"{directory_path}area_info_{dateoftoday}.json", "w") as outfile:
#     outfile.write(json.dumps(area_info, sort_keys=False))

# with open(f"{directory_path}area_info_{dateoftoday}.txt", "w") as outfile:
#     outfile.write(json.dumps(area_info, sort_keys=False))
